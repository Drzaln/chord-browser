...
| **Tests**                        | **748 passing** (`swift test`, 108 suites), measured 2026-09-17                                                                                                                                |
...
- Not persisted per Space: only the active Space's blank survives a relaunch (via
  the saved nil `selectedTabID`); other Spaces restore their last tab.

**Tests.** `blankIsPerSpaceOnSwitch`, `returningRestoresTab`,
`blankSpaceSurvivesActivityElsewhere` (SpaceTests),
`blankWindowSurvivesOtherWindowActivity` (MultiWindowTests) — **748 total, green**.
