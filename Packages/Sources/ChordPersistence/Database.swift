...
public struct ChordDatabase: Sendable {
    public let writer: DatabaseQueue

    public static func open(at url: URL) throws -> ChordDatabase {
        ...
        return ChordDatabase(writer: queue)
    }

    /// In-memory store for tests.
    public static func inMemory() throws -> ChordDatabase {
